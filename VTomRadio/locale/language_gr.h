...
const char weatherFmt[] PROGMEM =
  "%s, %.1f°C \007 αίσθηση θερμοκρασίας: %.1f°C \007 πίεση: %d hPa \007 υγρασία: %d%% \007 άνεμος: %.1f " WIND_UNIT " [%s]";
  #else
const char weatherFmt[] PROGMEM = "%s, %.1f°C \007 Πίεση: %d hPa \007 Υγρασία: %d%%";
  #endif
#endif
